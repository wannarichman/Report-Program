                ...
                "sections": [
                    {
                        ...
                        "chart_data": "1분기, 35\n2분기, 50\n3분기, 42\n4분기, 68",
                        "lines": [
                            {"text": "• 위 이미지는 프로젝트 현장 또는 설계 도면을 나타냅니다.", "size": 22, "color": "#1e293b"},
                            {"text": "• 데이터 차트를 통해 분기별 실적 추이를 직관적으로 확인할 수 있습니다.", "size": 22, "color": "#1e293b"},
                        ],
                        "side_items": [
                            {"type": "metric", "label": "정량 지표", "value": "목표 달성률: 85%\n비용 절감액: 1.2억", "color": "#16a34a", "label_fs": 14, "label_color": "#64748b", "value_fs": 22}
                        ],
                    }
                ],
            },
